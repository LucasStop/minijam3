...
export function DebugPanel() {
  ...
  return (
    <div className='absolute bottom-4 left-4 z-20 bg-black bg-opacity-80 text-white p-3 rounded-lg text-xs font-mono pointer-events-none'>
      <h3 className='text-yellow-400 font-bold mb-2'>🔍 DEBUG MODE</h3>
      <div className='space-y-1'>
        <p>
          Inimigos ativos:{' '}
          <span className='text-cyan-400'>{enemies.length}</span>
        </p>
        <p>
          Hitboxes integradas: <span className='text-green-400'>ATIVAS</span>
        </p>
