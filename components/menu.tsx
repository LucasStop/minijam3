    ...
    <div className='fixed inset-0 bg-gradient-to-b from-purple-900 via-blue-900 to-black flex items-center justify-center'>
      <div className='text-center text-white'>
        ...
        <p className='text-xl text-gray-300 mb-12'>
          Sobreviva às ondas de inimigos alienígenas!
        </p>{' '}
        ...
        <div className='mt-12 text-sm text-gray-300 space-y-1'>
          <p>
            🎮 <strong>WASD:</strong> Mover nave no plano 2D
          </p>
          <p>
            🚀 <strong>SPACE:</strong> Acelerar | <strong>CTRL:</strong> Frear
          </p>
          <p>
            🎯 <strong>MOUSE:</strong> Mirar e atirar (Clique Esquerdo)
          </p>
