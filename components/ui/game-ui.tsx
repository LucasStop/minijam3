      ...
      <div className='absolute inset-0 bg-black/80 flex items-center justify-center z-50'>
        <div className='text-center space-y-8'>
          ...
          <div className='space-y-4 text-gray-400'>
            <p>
              🎮 <strong>WASD</strong> - Mover
            </p>
            <p>
              🖱️ <strong>Mouse</strong> - Mirar e Atirar
            </p>
            <p>
              🎯 <strong>Clique nos inimigos</strong> - Tiro direcionado
            </p>
          </div>
                ...
                <div className='text-gray-300'>
                  <div>
                    ...
                    <span className='text-white font-bold'>
                      {collisionStats.shotsFired}
                    </span>
                  </div>
                  <div>
                    💥 Inimigos Atingidos:{' '}
                    <span className='text-green-400 font-bold'>
                      {collisionStats.projectileHits}
                    </span>
                  </div>
                </div>
                <div className='text-gray-300'>
                  ...
                  <div>
                    ...
                    <span className='text-blue-400 font-bold'>
                      {collisionStats.accuracy.toFixed(1)}%
                    </span>
                  </div>
                </div>
              </div>
  ...
  return (
    <div className='absolute inset-0 pointer-events-none z-40'>
      ...
      <div className='absolute top-4 left-4 right-4 flex justify-between items-start pointer-events-none'>
        {/* Pontuação */}
        <div
          className={`bg-black/70 backdrop-blur-sm px-6 py-3 rounded-lg transition-all duration-300 ${scoreAnimation ? 'scale-110 bg-yellow-500/70' : ''}`}
        >
          ...
          {debugMode && (
            <div className='mt-2 pt-2 border-t border-gray-600'>
              <div className='text-xs text-gray-300'>
                <div>
                  📊 Tiros: {collisionStats.shotsFired} | Acertos:{' '}
                  {collisionStats.projectileHits}
                </div>
