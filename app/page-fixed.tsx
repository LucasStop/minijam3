...
export default function App() {
  const [currentScreen, setCurrentScreen] = useState<"menu" | "playing" | "about" | "gameOver" | "v0" | "v1">("menu")
  ...
  const renderScreen = () => {
    switch (currentScreen) {
      case "menu":
        return <Menu onStartGame={() => setCurrentScreen("playing")} onShowAbout={() => setCurrentScreen("about")} onStartV0={() => setCurrentScreen("v0")} onStartV1={() => setCurrentScreen("v1")} />
      case "about":
